...
#corr_matrix <- cor(dat2[,4:10]) 
#ggcorrplot(corr_matrix) # view a correlation matrix for the variables

# try adding other data (scored characters) into the dataset and incorporate those into 
data.pca <- princomp(dat2[,c(4:6,8:9)], cor=TRUE) # calculate PCA analysis
